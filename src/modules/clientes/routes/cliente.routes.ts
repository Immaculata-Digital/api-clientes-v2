...
clienteRoutes.get('/:schema/:id/pontos-movimentacoes', tenantSchema, clienteController.getMovimentacoes)
clienteRoutes.get('/:schema/:id/pontos-recompensas', tenantSchema, clienteController.getPontosRecompensas)
...
// Rota para buscar detalhes do resgate por ID (deve vir antes de /:schema/:id)
clienteRoutes.get('/:schema/resgates/:idResgate', tenantSchema, clienteController.getDetalhesResgate)
